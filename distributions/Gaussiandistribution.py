...
class Gaussian(Distribution):
    ...
    def calculate_stdev (self, sample = True):
        """Function to calculate the standard deviation of the dta set.
    ...
    def read_data_file(self, file_name, sample = True):
        ...
        one number(float) per line. The number are stored in the dta attribute.
    ...
    def plot_histogram_pdf(self, n_spaces = 50):
        """Function to plot the normalized histogram fo the data and a plot of the 
        probability density function along the same range
        
        Args:
            m_spaces (int): number of data points
